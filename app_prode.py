...
with col_info:
    st.info("ℹ️ Si quieres competir en un grupo cerrado con amigos o compañeros, escriban todos **EXACTAMENTE EL MISMO NOMBRE** aquí. Si lo dejas vacío, participas solo en la General.")
